...
const MeetingsPage = () => {
  ...
  }, [fetchManagerUsersMeetings, currentPage, itemsPerPage, user?.companyId, selectedLeadId]);
    ...
    return (
      <div className="h-full flex flex-col items-center justify-center text-red-500">
        ...
        <button
          ...
          onClick={() => user?.companyId && fetchManagerUsersMeetings({
            page: currentPage,
            limit: itemsPerPage,
            companyId: user.companyId
          })}
